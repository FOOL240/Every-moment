...
<body>
   ...
   <div class="men">
   	 <div class="container">
   	  <div class="grid_1">
	   	  <h1>联络资料</h1>
	   	  <p>家庭作业或局局局长可以坐下来，进行数码摄影或任何大型演出。在vero和组合下，只允许坐坐当前不明朗的临时财产。Nam liber tempor eleifend选项可以让我们知道它们在mazim中是独立的。</p>
      </div>
      <div class="grid_4">
      <div class="grid_2 preffix_1">
	      <ul class="iphone">
	      	<i class="phone"> </i>
	      	<li class="phone_desc">电话 : +1 800 245 2365 </li>
	      	<div class="clearfix"> </div>
	      </ul>
	      <ul class="iphone">
	      	<i class="flag"> </i>
	        <li class="phone_desc">网址 : <a href="mailto:mail@demolink.org">www.demolink.com</a></li>
	      	<div class="clearfix"> </div>
	      </ul>
	  </div>
	  <div class="grid_3">
	      <ul class="iphone">
	      	<i class="msg"> </i>
	        <li class="phone_desc">电子邮件 : <a href="mailto:mail@demolink.org">mail(at)watches.com</a> </li>
	      	<div class="clearfix"> </div>
	      </ul>
	      <ul class="iphone">
	      	<i class="home"> </i>
	        <li class="phone_desc">地址 :四川省成都市青羊区文家正街227号 </li>
	      	<div class="clearfix"> </div>
	      </ul>
	  </div>
	  <div class="clearfix"> </div>
	 ...
	 <div class="contact_form">
	    ...
	    <form>
            ...
            <div class="clearfix"></div>
            <div class="but__center"><input type="submit" value="发送讯息 &gt;&gt;"></div>
        </form>
     </div>
    </div>
   </div>
