		...
		<div class="col-md-7 account-top">
		  <form action="${pageContext.request.contextPath}/login" method="post">
			...
			<div> 
				...
				<input type="submit" style="position:relative;left:75px;" value="登录"> <a href="${pageContext.request.contextPath}/views/modifies.jsp" style="position:relative;left:303px;">忘记密码</a>
		   </form>
		</div>
